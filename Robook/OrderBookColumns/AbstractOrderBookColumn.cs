...
public abstract class AbstractOrderBookColumn : DataGridViewTextBoxColumn {
    ...
    /// <summary>
    /// <para>Occurs after a value has been changed for the <see cref="OrderBook.OBDT"/> column,
    ...
    public abstract void OnColumnChanged(DataColumnChangeEventArgs e, OrderBook orderBook);
